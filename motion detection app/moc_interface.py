import motion_detection_algorithms.moving_object_classifier as moving_object_classifier
...
class Video_interface(customtkinter.CTkToplevel):
    ...
    def start_video(self):
        ...
        if detections != False:
            ...
            captured_image2 = Image.fromarray(mask)
            ...
            captured_image3 = Image.fromarray(img)
